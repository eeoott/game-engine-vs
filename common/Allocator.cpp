...
GEVS::Allocator::Allocator(size_t data_size, size_t page_size, size_t alignment)
    : m_pPageList(nullptr), m_pFreeList(nullptr)
{
...
void GEVS::Allocator::Reset(size_t data_size, size_t page_size, size_t alignment)
{
    FreeAll();
...
void GEVS::Allocator::Free(void* p)
{
...
#if defined(_DEBUG)
void GEVS::Allocator::FillFreePage(PageHeader* pPage)
{
    // page header
    pPage->pNext = nullptr;
...
void GEVS::Allocator::FillFreeBlock(BlockHeader* pBlock)
{
    // block header + data
...
void GEVS::Allocator::FillAllocatedBlock(BlockHeader* pBlock)
{
    // block header + data
...
GEVS::BlockHeader* GEVS::Allocator::NextBlock(BlockHeader* pBlock)
{
