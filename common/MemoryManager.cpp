...
int GEVS::MemoryManager::Initialize()
{
...
void GEVS::MemoryManager::Finalize()
{
    delete[] m_pAllocators;
    delete[] m_pBlockSizeLookup;
}

void GEVS::MemoryManager::Tick()
{
}

GEVS::Allocator* GEVS::MemoryManager::LookUpAllocator(size_t size)
{
...
void* GEVS::MemoryManager::Allocate(size_t size)
{
...
void GEVS::MemoryManager::Free(void* p, size_t size)
{
    Allocator* pAlloc = LookUpAllocator(size);
